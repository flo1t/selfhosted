...
data_pause = {'Text':'The Playback is running for more then 2 hours without interaction: Pausing playback','TimeoutMs':'30000'}
...
if (len(users_with_active_sessions) >= 1):
  print(f"{len(users_with_active_sessions)} active sessions found. Checking if they have simultaneous or longrunning streams.")
else:
