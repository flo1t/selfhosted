...
ZONE = args.zone or os.getenv('CLOUDFLARE_ZONE_ID')
PATTERNS_RAW = args.route_patterns or os.getenv('CLOUDFLARE_ROUTE_PATTERNS')
WORKER = args.route_worker or os.getenv('CLOUDFLARE_ROUTE_WORKER')
TOKEN = args.token or os.getenv('CLOUDFLARE_API_TOKEN')
DISCORD_URL = args.discord or os.getenv('DISCORD_NOTIFICATIONS_URL')
